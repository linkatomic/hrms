...
const { useState: useState_lv, useEffect: useEffect_lv } = React;

const Leave = ({ data, role }) => {
  const [tab, setTab] = useState_lv("my"); // my | team | apply
  const [draft, setDraft] = useState_lv({
    kind: "Paid Time Off",
    from: "2026-06-08",
    to: "2026-06-12",
  ...
  return (
    <div data-screen-label="04 Leave">
